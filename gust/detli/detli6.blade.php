...
<div class="container py-5">
    <div class="row align-items-center">
        ...
        <div class="col-md-6 mb-4 mb-md-0">
            <img src="{{ asset('images/c.jpg') }}" class="img-fluid product-img" alt="Red T-Shirt">
        </div>
    ...
    <div class="review-section mt-5">
        <h4 class="mb-4">Customer Ratings & Reviews</h4>
        ...
        <div class="review">
            ...
            <div class="text">
                Great quality and fits perfectly. Will buy again!
            </div>
        </div>

        <div class="review">
            <div class="name">Sneha Patel</div>
            <div class="stars">
                ★★★★★
            </div>
            <div class="text">
                Loved the fabric and color. It’s very comfortable.
            </div>
        </div>
        ...
        <div class="review">
            ...
            <div class="text">
                Decent product for the price, but the color faded a bit after wash.
            </div>
        </div>
    </div>
</div>
