...
<div class="container py-5">
    <div class="row align-items-center">
        ...
        <div class="col-md-6 mb-4 mb-md-0">
            <img src="{{ asset('images/d.jpg') }}" class="img-fluid product-img" alt="Red T-Shirt">
        </div>
    ...
    <div class="review-section mt-5">
        ...
        <div class="review">
            ...
            <p><strong>Ravi Kumar:</strong> The t-shirt is very comfortable and fits perfectly. Great quality!</p>
        </div>
        ...
        <div class="review">
            ...
            <p><strong>Anjali Verma:</strong> Loved the fabric and color. Definitely worth the price.</p>
        </div>
        ...
        <div class="review">
            ...
            <p><strong>Sameer Shah:</strong> Good but the color faded slightly after washing.</p>
        </div>
    </div>
</div>
