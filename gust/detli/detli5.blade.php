...
<div class="container py-5">
    <div class="row align-items-center">
        ...
        <div class="col-md-6 mb-4 mb-md-0">
            <img src="{{ asset('images/blue.jpg') }}" class="img-fluid product-img" alt="Red T-Shirt">
        </div>
    ...
    <div class="review-section">
        ...
        <div class="review">
            <h6>Rahul Sharma</h6>
            <div class="stars">★★★★★</div>
            <p>Very good quality and fast delivery. Recommended!</p>
        </div>

        <div class="review">
            <h6>Anjali Mehta</h6>
            <div class="stars">★★★★☆</div>
            <p>Nice fit and comfortable. Color is also very good.</p>
        </div>

        <div class="review">
            <h6>Vikram Patel</h6>
            <div class="stars">★★★★★</div>
            <p>Excellent T-shirt for daily wear. Worth the price.</p>
        </div>
    </div>
</div>
