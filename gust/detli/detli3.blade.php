...
<div class="container py-5">
    <div class="row align-items-center">
        ...
        <div class="col-md-6 mb-4 mb-md-0">
            <img src="{{ asset('images/athleisure.jpg') }}" class="img-fluid product-img" alt="Red T-Shirt">
        </div>
    ...
    <!-- Static Rating and Review Section -->
    <div class="review-section mt-5">
        ...
        <div class="review">
            <h6>Amit Sharma</h6>
            <div class="stars">★★★★☆</div>
            <p>Great quality fabric and fits perfectly. Totally worth the price.</p>
        </div>

        <div class="review">
            <h6>Priya Verma</h6>
            <div class="stars">★★★★★</div>
            <p>Color is vibrant and stays the same even after multiple washes.</p>
        </div>

        <div class="review">
            <h6>Rahul Mehta</h6>
            <div class="stars">★★★☆☆</div>
            <p>Good for casual wear, but I expected better packaging.</p>
        </div>
    </div>
</div>
