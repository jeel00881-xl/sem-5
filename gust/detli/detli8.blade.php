...
<div class="container py-5">
    <div class="row align-items-center">
        ...
        <div class="col-md-6 mb-4 mb-md-0">
            <img src="{{ asset('images/zali.jpg') }}" class="img-fluid product-img" alt="Red T-Shirt">
        </div>
    ...
    <div class="review-section mt-5">
        ...
        <div class="review">
            <div class="stars">★★★★★</div>
            <h6>Ravi Sharma</h6>
            <p>Very good quality! Fits perfectly and feels soft.</p>
        </div>

        <div class="review">
            <div class="stars">★★★★☆</div>
            <h6>Neha Patel</h6>
            <p>Nice t-shirt. Color is vibrant. Slightly loose fit though.</p>
        </div>

        <div class="review">
            <div class="stars">★★★★★</div>
            <h6>Amit Kumar</h6>
            <p>Excellent product for the price. Loved the fabric!</p>
        </div>
    </div>
</div>
